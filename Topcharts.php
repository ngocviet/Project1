            ...
            <div class="grid">
                <div class="grid__row">
                    <div class="grid__column--12-12">
                        <div class="header__trending">SOUNDBLAST HOT 10</div>
                    </div>
                </div>
                ...
                <div class="grid__row">
                    <?php
                        $sql = "SELECT * FROM the_song where top_charts <> 'null' ORDER BY top_charts limit 1";
                        $viet = $conn->query($sql);
                    ...
                    <div class="grid__column--8-12 container__trending--img">
                        ...
                        <div class="location"><?php echo($rows['top_charts']) ?></div>
                    </div>
                            ...
                            <div id="stats__table">
                                <div class="grid__row">
                                    <div class="grid__column--6-12">
                                        ...
                                        <span><?php echo($rows['top_last_week_charts']) ?></span>
                                    </div>
                                    <div class="grid__column--6-12">
                ...
                <?php
                    $sql = "SELECT * FROM the_song where top_charts <> 'null' ORDER BY top_charts limit 1,9";
                    $viet = $conn->query($sql);
                    while($rows=$viet->fetch_assoc()){
                ?>
                <div class="grid__row">
                    <div class="top50">
                        <div class="grid__column--9-12">
                            <div class="top50_img">
                                ...
                                <div class="location__top"><?php echo($rows['top_charts']) ?></div>
                            </div>
                            <div class="info">
