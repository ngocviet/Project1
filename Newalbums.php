            ...
            <div class="grid">
                <div class="grid__row" id="release__header">
                    <div class="release__heading">
                        <h1>The New Albums Of 2022</h1>
                    </div>
                    <div class="release__imgheading" style="background-image: url(./assets/img/Logo-Background/2022-Albums-so-far.jpg);">
                    </div>
                ...
                <?php
                    $sql = "SELECT * FROM new_release where topic = 'newalbum'";
                    $viet = $conn -> query($sql);
                    ...
                    $start = ($page-1)*8;
                    $sql = "SELECT * FROM new_release where topic = 'newalbum' limit $start,8";
                    $viet = $conn->query($sql);
                    ...
                    <div class="grid__row release__list">
                        ...
                        <div class="grid__column--6-12">
                            <div class="release__main">
                                ...
                                <div class="release__img" style="background-image: url(./assets/img/Other/<?php echo$rows['link'] ?>);"></div>
                            </div>
                        </div>
                        <div class="grid__column--6-12">
...
<script>
    function page(x){
        window.location.href = "Newalbums.php?page="+x;
    }
